...
h2. Sharing is careing, its on github, go forth and fork

"*https://github.com/nickanderson/CFEngine-3-by-example-vagrant*":https://github.com/nickanderson/CFEngine-3-by-example-vagrant

# Clone the project
# Run make && vagrant up 
** (you need to have installed Virtualbox, Vagrant, and the CFEngine provisioner)
...
h1(fullscreen). Before we get to far lets cover some fundamentals
{{ gradient silver white silver white }}
...
h1. Notes
{{ gradient silver white silver white }}
* This presentation is on github too 
